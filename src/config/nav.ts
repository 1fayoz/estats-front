  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: BarChart3,
        children: [
          { label: "Kartochka asosida", action: "market.products", href: "/market/products" as Route, icon: Boxes },
          { label: "SKU asosida", action: "market.skus", href: "/market/skus" as Route, icon: Boxes },
          { label: "Mahsulot kartochkasi", action: "market.card", href: "/market/card" as Route, icon: Boxes },
          { label: "Kartochkalar jadvali", action: "market.card_table", href: "/market/card-table" as Route, icon: Boxes },
        ],
      },
      {
        label: "SEO | Joylashuv",
        ...
        icon: FileText,
        children: [
          { label: "Mahsulot kalitlari", action: "market.seo", href: "/market/seo" as Route, icon: Boxes },
          { label: "Kalit soʻz tahlili", action: "market.seo_keyword", href: "/market/seo/keyword" as Route, icon: Boxes },
          { label: "Raqobatchilar va pozitsiyalar", action: "market.seo_competitors",
      ...
      },
      {
        ...
        icon: Building2,
        children: [
          { label: "Do\u2019konlar reytingi", action: "market.shops", href: "/market/shops" as Route, icon: Boxes },
          { label: "Do\u2019kon tahlili", action: "market.shop", href: "/market/shop" as Route, icon: Boxes },
          { label: "Sotuvchining SKUlari", action: "market.seller_skus", href: "/market/seller-skus" as Route, icon: Boxes },
          { label: "Sotuvchilar", action: "market.sellers", href: "/market/sellers" as Route, icon: Boxes },
        ],
      },
    ],
  },
